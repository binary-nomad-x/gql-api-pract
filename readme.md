...
Running `npm run seed` creates approximately 10,000+ records across all tables including users, posts, products, orders, reviews, notifications, and more.
...
- `NotificationType`: `SYSTEM | ORDER_UPDATE | PAYMENT_RECEIVED | SHIPMENT_UPDATE | NEW_FOLLOWER | NEW_COMMENT | PROMOTION`
